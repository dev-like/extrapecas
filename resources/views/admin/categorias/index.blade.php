            ...
            <table class="table table-striped" id="tabela">
                ...
                @forelse($categorias as $categoria)
                    <tr id={{$categoria->id}}>
                        ...
                        <td width="10%">
                            <span class="hint--top" aria-label="Editar categoria">
                                <a href="{{ route('categorias.edit', $categoria->id) }}" style="border-radius: 50%"
                                   class="btn btn-warning waves-effect">
                                    <i class="fa fa-pencil m-r-5"></i>
                                </a>
                            </span>
                            <span class="hint--top" aria-label="Deletar categoria">
                                <button type="button" onclick="goswet({{$categoria->id}})"
