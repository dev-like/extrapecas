			...
			<div id="js-navbar-fixed" class="menu-desktop">
				<div class="container menu-desktop-inner">
					...
					<div class="logo d-flex align-items-center ">
							<a href="{{url('/')}}">
								<img class="logoimgheader" src="{{url('/')}}/site/images/icons/logo-black.png">
							</a>
					</div>
					<!-- Main Menu -->
					<nav class="main-menu">
						<ul>
							<li class="menu-item">
								<a href="{{url('/')}}#quemsomos" class="font-weight-bold">
								QUEM SOMOS
								</a>
							</li>
							<li class="menu-item">
								<a href="{{url('/')}}#parceiros" class="font-weight-bold">
									PARCEIROS
								</a>
							</li>
							<li class="menu-item">
							...
							<li class="menu-item">
								<a href="{{url('/')}}#contato" class="font-weight-bold">
									CONTATO
								</a>
							</li>
							<li class="menu-item">
								<a href="/segundavia" class="font-weight-bold">
									SEGUNDA VIA
								</a>
							</li>
						</ul>
		...
		<div class="show-mobile-header">
			...
			<div class="mobile-top-header d-flex align-items-center justify-content-between">
				<div class="logo-mobile">
					<a href="/"><img src="{{url('/')}}/site/images/icons/logo.png" class="img-logo" alt="logo"></a>
				</div>
